...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, opacityback=0, colframe=quarto-callout-warning-color-frame, toptitle=1mm, toprule=.15mm, bottomrule=.15mm, bottomtitle=1mm, title={Task}, colback=white, breakable, arc=.35mm, rightrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, leftrule=.75mm, left=2mm, coltitle=black, opacitybacktitle=0.6]
