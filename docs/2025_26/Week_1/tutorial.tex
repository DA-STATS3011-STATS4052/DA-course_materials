...
\begin{tcolorbox}[enhanced jigsaw, left=2mm, breakable, toptitle=1mm, leftrule=.75mm, toprule=.15mm, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, opacityback=0, title={Task}, coltitle=black, titlerule=0mm, colbacktitle=quarto-callout-warning-color!10!white, colback=white, bottomrule=.15mm, bottomtitle=1mm, arc=.35mm, rightrule=.15mm]
