...
Then, click the render ![](images/rstudio-render-button.png){width="24" height="20"} button and compile your Quarto document to be sure that your markdown formatting produces the expected output in your HTML document.
