...
Again, the AUC of `r round(roc_res$.estimate,2)` indicates a moderate-poor fit to the data (mainly due to miss-classifications of female instructors as we saw previously).
